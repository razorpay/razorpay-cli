...
var paymentsCmd = &cobra.Command{
	Use:   "payments <qr_code_id>",
	Short: "Fetch payments for a QR code",
...
func init() {
	...
	paymentsCmd.Flags().Int("count", 10, "Number of payments to fetch")
	paymentsCmd.Flags().Int("skip", 0, "Number of payments to skip")
	paymentsCmd.Flags().Int64("from", 0, "Unix timestamp lower bound")
	paymentsCmd.Flags().Int64("to", 0, "Unix timestamp upper bound")
}
